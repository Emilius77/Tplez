...
public class DemoBiblioteca {
    ...
    public static void main(String[] args) {
        ...
        Prestito p1 = new Prestito(1, 1, "Sir Marco - 1) Il signore degli anelli " + " - " + new Date().toString());
        Prestito p2 = new Prestito(4, 2, "Russo Davide - 4) Enigma" + " - " + new Date().toString());
